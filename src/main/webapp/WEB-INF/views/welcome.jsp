...
<nav role="navigation" class="navbar navbar-default">
    <div>
        <nav class="menu">
            <ul>
                <li><a href="<spring:url value="${pageContext.request.contextPath}/controller?command=login_page"/>">Login</a></li>
                <li><a href="<spring:url value="${pageContext.servletContext.contextPath}/controller?command=sign_out"/>">Logout</a></li>
